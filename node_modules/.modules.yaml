...
hoistedDependencies:
  ...
  /vite-node/1.5.2(@types/node@20.12.7):
    vite-node: private
  /vitepress/1.0.0-rc.44(@algolia/client-search@4.23.3)(@types/node@20.12.7)(postcss@8.4.38)(search-insights@2.13.0)(typescript@5.4.5):
    vitepress: private
...
pendingBuilds: []
prunedAt: Sun, 28 Apr 2024 15:58:09 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
